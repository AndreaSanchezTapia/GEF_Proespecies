...
clip <- readr::read_csv("data/dados_formatados/Clip/Planilha_Clip_Livro_Vermelhor_T20 - Planilha_Clip_Livro_Vermelhor_T.csv",
                        guess_max = 100000)
...
clip %>% filter(mpo_check %in% mpos_t20$mpo_check & specie %in% spp$nome_aceito_correto) %>% write_csv("output/p3/cncflora.csv")
